...
#list_data <- #uncomment when you've finished 3a-3c 
    ...
    # 3b. days between infection, onset, hospitalization
      mutate(time_to_recovery = [ADD CODE],
             ...
             hosp_days = [ADD CODE]) |> 
    # 3c. Cconvert onset date to EPI week. An epidemiological week (EPI week) is a standardized method for counting weeks that allows for the comparison of data year after year.
