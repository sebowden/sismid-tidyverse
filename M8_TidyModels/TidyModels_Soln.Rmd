...
lm_workflow <- 
  workflow() |>
  add_model(lm_model) |>
  add_formula(duration ~ age + outcome + ct_blood)
...
lm_workflow <- 
  workflow() |>
  add_model(log_model) |>
  add_formula(outcome ~ duration + age + fever + ct_blood)
